...
async function listUserBookBySearch(userBookRepository, {userId, page, limit, search = ''}) {
    const listBook = await userBookRepository.findUserBooksWithDetailsBySearch(userId, page, limit, search);
    if (!listBook) {
...
module.exports = listUserBookBySearch;
